...
RESOURCES += src/qt/minnodes.qrc src/qt/minnodes_locale.qrc

TRANSLATIONS += src/qt/locale/minnodes_bg.ts \
                src/qt/locale/minnodes_de.ts \
                src/qt/locale/minnodes_en.ts \
                src/qt/locale/minnodes_es.ts \
                src/qt/locale/minnodes_fi.ts \
                src/qt/locale/minnodes_fr.ts \
                src/qt/locale/minnodes_it.ts \
                src/qt/locale/minnodes_ja.ts \
                src/qt/locale/minnodes_pl.ts \
                src/qt/locale/minnodes_pt.ts \
                src/qt/locale/minnodes_ru.ts \
                src/qt/locale/minnodes_sk.ts \
                src/qt/locale/minnodes_sv.ts \
                src/qt/locale/minnodes_vi.ts \
                src/qt/locale/minnodes_zh_CN.ts \
                src/qt/locale/minnodes_zh_TW.ts
