Contributing to Minnodes Core
============================

The Minnodes Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Minnodes Core project, and is not to be
confused with overall Minnodes Network Protocol consensus changes.

Whether a pull request is merged into Minnodes Core rests with the project merge
...
Patches that change Minnodes consensus rules are considerably more involved than
...
Where a patch set proposes to change the Minnodes consensus, it must have been
...
The project leader is the release manager for each Minnodes Core release.
