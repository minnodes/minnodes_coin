...
In order to support loading of multiple wallets in minnodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is minnodes.cpp.
...
Changes to minnodes.cpp
----------------------
minnodes.cpp is the entry point into minnodes-qt, and as such, will require some minor modifications to provide hooks for
