...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/minnodes/minnodes_coin/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Minnodes Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit minnodes=v${VERSION} ../minnodes/contrib/gitian-descriptors/gitian-win.yml
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/minnodes/minnodes_coin/releases/new) with a link to the archived release notes.
