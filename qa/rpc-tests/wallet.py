...
#   c) node1 mines 32 blocks, so now node 0 has 60001minc, node 1 has 4250minc, node2 has none.
#   d) node0 sends 601 minc to node2, in two transactions (301 minc, then 300 minc).
