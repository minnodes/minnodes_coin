                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Minnodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Minnodes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and minnodes: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMINC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Minnodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about Minnodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Minnodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Minnodes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Minnodes addresses"));
    ...
    openAction->setStatusTip(tr("Open a Minnodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Minnodes Core help message to get a list with possible Minnodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Minnodes Core wallet") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Minnodes network", "", count));
}
...
{
    QString strTitle = tr("Minnodes Core"); // default title
