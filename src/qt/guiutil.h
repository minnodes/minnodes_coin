...
/** Utility functions used by the Minnodes Qt UI.
 */
namespace GUIUtil
{
...
// Render Minnodes addresses in monospace font
...
// Parse "minnodes:" URI into recipient object, return true on successful parsing
