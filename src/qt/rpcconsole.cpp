                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMINCPathCustom = GetArg("-zmincbackuppath", "");
    ...
    if(!strzMINCPathCustom.empty()) {
        ui->wallet_customzmincbackuppath->setText(QString::fromStdString(strzMINCPathCustom));
        ui->wallet_customzmincbackuppath_label->setVisible(true);
        ui->wallet_customzmincbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMINCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        ...
        "td.cmd-request { color: #4bb5f6; } "
        "td.cmd-error { color: red; } "
        "b { color: #4bb5f6; } ");

    message(CMD_REPLY, (tr("Welcome to the Minnodes RPC console.") + "<br>" +
