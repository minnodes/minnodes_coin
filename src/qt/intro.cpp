...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Minnodes Core"),
     ...
     * override -datadir in the minnodes.conf file in the default data directory
     * (to be consistent with minnodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
