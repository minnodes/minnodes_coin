...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::MINC, nValue);
...
{
    std::string genesisblockhash = "000002f316024198411a7f65a1fa3637f376456a8210605b22cccd9b6d0f80ed";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (minnodes.conf).");
            QMessageBox::warning(this, "Minnodes Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#3c394b;}\n a, span { font-family: monospace; }\n span.addr {color:#808080; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #3c394b;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#ff6d4a;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#9f5549;}\n";
