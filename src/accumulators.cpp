...
bool ValidateAccumulatorCheckpoint(const CBlock& block, CBlockIndex* pindex, AccumulatorMap& mapAccumulators)
{
    ...
    //It is VERY IMPORTANT that when this is being run and height < v2_start, then zMINC need to be disabled at the same time!!
...
//    bool fDoubleCounted = false;
    while (pindex) {
        ...
        // 10 blocks were accumulated twice when zMINC v2 was activated
