...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Minnodes Core minnodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  minnodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded minnodes transaction") + "\n" +
                               "  minnodes-tx [options] -create [commands]   " + _("Create hex-encoded minnodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded minnodes transaction
