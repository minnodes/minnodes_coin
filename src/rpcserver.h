...
/**
 * Minnodes RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmincseed(const UniValue& params, bool fHelp);
extern UniValue getzmincseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzminc(const UniValue& params, bool fHelp);
extern UniValue dzmincstate(const UniValue& params, bool fHelp);
