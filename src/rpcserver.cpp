...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Minnodes server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Minnodes server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Minnodes features */
        {"minnodes", "masternode", &masternode, true, true, false},
        {"minnodes", "listmasternodes", &listmasternodes, true, true, false},
        {"minnodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"minnodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"minnodes", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"minnodes", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"minnodes", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"minnodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"minnodes", "masternodedebug", &masternodedebug, true, true, false},
        {"minnodes", "startmasternode", &startmasternode, true, true, false},
        {"minnodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"minnodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"minnodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"minnodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"minnodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"minnodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"minnodes", "mnbudget", &mnbudget, true, true, false},
        {"minnodes", "preparebudget", &preparebudget, true, true, false},
        {"minnodes", "submitbudget", &submitbudget, true, true, false},
        {"minnodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"minnodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"minnodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"minnodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"minnodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"minnodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"minnodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"minnodes", "checkbudgets", &checkbudgets, true, true, false},
        {"minnodes", "mnsync", &mnsync, true, true, false},
        {"minnodes", "spork", &spork, true, true, false},
        {"minnodes", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmincseed", &getzmincseed, false, false, true},
        {"zerocoin", "setzmincseed", &setzmincseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzminc", &searchdzminc, false, false, true},
        {"zerocoin", "dzmincstate", &dzmincstate, false, false, true}
...
{
    return "> minnodes-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11332/\n";
}
